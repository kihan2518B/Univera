...
//             <p className="p-3 bg-gray-50 rounded">{submittedData.title}</p>
//           </div>
...
//             extractYoutubeVideoId(submittedData.youtubeUrl) && (
//               <div className="mb-6">
//                 <h3 className="text-xl font-semibold mb-2">Video:</h3>
//                 <div className="aspect-w-16 aspect-h-9">
//                   <iframe
//                     className="w-full h-64"
//                     src={`https://www.youtube.com/embed/${extractYoutubeVideoId(submittedData.youtubeUrl)}`}
...
//             />
//             <p className="text-sm text-gray-500 mt-1">
//               YouTube and Google Drive video links are supported
//             </p>
...
//             />
//             <p className="text-sm text-gray-500 mt-1">
//               Accepted file types: PDF, DOCX, TXT, etc.
//             </p>
